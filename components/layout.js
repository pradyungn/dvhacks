  ...
  return (
    <>
      ...
      >
        ...
        <A variant="styles.navitem" href="https://dvhacks-iii.devpost.com">Devpost</A>
        <Link href="/about">
      ...
      >
        ...
        >
          <Flex sx={{ justifyContent: 'center' }}>
            <A
              href="https://instagram.com/dvhacks"
              title="Instagram"
              sx={{ mx: 2 }}
            >
            ...
            <A
              href="https://github.com/pradyungn/dvhacks"
              title="GitHub"
              sx={{ mx: 2 }}
            >
              <Icon glyph="github" size={36} />
            </A>
            <A href="mailto:info@dvhacks.tech" title="Email" sx={{ mx: 2 }}>
